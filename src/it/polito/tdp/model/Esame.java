...
public class Esame {
	...
	/**Oggetto che contiene i dati di un singolo esame!
	...
	private String docente;   // oppure private Docente docente, che sarebbe più completo
	...
	public Esame(String codice, String titolo, String docente) {
		...
		this.superato=false;
		/**
		 * Ho definito un nuovo esame, non ancora superato, che contiene:
		 * codice dell'esame
	...
	/**
	 * deve restituire il voto solo se l'esame è stato superato, altimenti eccezione!
	 * @return the voto
	 */
	public int getVoto() {
		if(this.superato){
	...
	/**
	 * deve restituire la data di superamento solo se l'esame è stato superato, altimenti eccezione!
	...
	/**
	 * se l'esame non è ancora superato lo definisce tale con il voto e la data specificati
	 * se invece l'esame è già stato superato --> genera un'eccezione
	 * @param voto
	 * @param data
	 */
	public void supera (int voto, LocalDate data){
		if(!this.superato){
			...
			throw new IllegalStateException("Esame "+this.codice+" già superato!");
			//potrei usare anche eccezione IllegalArgumentException (es.: se passo un voto = 40);
		}
	}
